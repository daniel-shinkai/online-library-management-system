<%-- 
    Document   : h_principalAssoc
    Created on : Oct 10, 2016, 2:35:42 AM
    Author     : Igor Santos
--%>
...
<html lang="en">
    <head>
        ...
        <title>Página de Associado</title>
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-3 col-md-2 sidebar">
                    ...
                    <ul class="nav nav-sidebar">
                        <li><a href="${pageContext.request.contextPath}/view/gerarHistorico.jsp">Consultar histórico</a></li>
                    </ul>
                </div>
